...
export const DeleteProjectSchema = z.object({
  ...
  storage_path: z
    .string()
    .optional()
    .describe("Optional absolute path to the directory where the memory project is stored."),
});
...
export const GetProjectContextSchema = z.object({
  storage_path: z
    .string()
    .optional()
    .describe("Optional absolute path to the directory to scan for context."),
});
